...
- **The dentition and the tooth cutaway are the published models.** Selecting adult arches loads the fourteen real lower teeth with a ligament around every root in the bone they sit in; zooming into one opens that tooth's own geometry on a clipping plane. The lower first molars come from the study that carries a pulp cavity, so they are the ones that show a canal. Upper teeth and the primary and mixed dentitions have no published model and stay procedural, labeled as such.
...
- The five muscles of mastication stay on with the muscle layer off: masseter, temporalis, the pterygoids and buccinator are the subject of this atlas rather than one of its 175 muscle meshes.
- Adult/child selection changes the actual 3D arches: the published lower arch for adults, or 20 primary and a representative 24-tooth mixed dentition as teaching geometry. Child teeth use different tissue proportions and root divergence, not a scaled adult skull.
